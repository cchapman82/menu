...
public class UpdateMIGUI implements GUIImplementation {
	...
	UpdateMIGUI(String type, String name) {
		...
		jl10.setBounds(60, 410, 100, 30);
		f.add(jl10);
		JTextArea ta10 = new JTextArea(objectInfo[8]);
		ta10.setBounds(180, 410, 260, 30);
		f.add(ta10);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(option == 0) {
					...
					if(!ta4.getText().equals(objectInfo[3])) {
						map.put(jl4.getText().toLowerCase().replace(":", ""), ta4.getText().toLowerCase().replace(",", "~"));
					}
					if(!ta5.getText().equals(objectInfo[4])) {
						map.put(jl5.getText().toLowerCase().replace(":", ""), ta5.getText().toLowerCase().replace(",", "~"));
					}
					if(!ta6.getText().equals(objectInfo[5])) {
						map.put(jl6.getText().toLowerCase().replace(":", ""), ta6.getText().toLowerCase().replace(",", "~"));
					}
					if(!ta7.getText().equals(objectInfo[6])) {
						map.put(jl7.getText().toLowerCase().replace(":", ""), ta7.getText().toLowerCase().replace(",", "~"));
					}
					if(!ta8.getText().equals(objectInfo[7])) {
						map.put(jl8.getText().toLowerCase().replace(":", ""), ta8.getText().toLowerCase().replace(",", "~"));
					}
					if(!ta9.getText().equals(objectInfo[8])) {
						map.put(jl9.getText().toLowerCase().replace(":", ""), ta9.getText().toLowerCase().replace(",", "~"));
					}
					if(!ta10.getText().equals(objectInfo[9])) {
						map.put(jl10.getText().toLowerCase().substring(0, jl10.getText().indexOf("(")), ta9.getText().toLowerCase().replace(",", "~"));
					}
