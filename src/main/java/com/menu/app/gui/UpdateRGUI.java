...
public class UpdateRGUI implements GUIImplementation {

        UpdateRGUI(String type, String name) {
		...
		JLabel ja2 = new JLabel("Location");
		...
		JLabel ja3 = new JLabel("Description");
		ja3.setBounds(60, 230, 260, 30);
		f.add(ja3);
